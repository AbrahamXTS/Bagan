	...
	<main class="container mt-16 mx-auto xl:w-1/2">
		<form class="flex flex-col mx-5">
			<div class="w-full relative">
				<input class="w-full rounded-xl border-2 border-gris py-3 pl-12 my-3 placeholder-texto" type="email" placeholder="Ejemplo@dcfgt.cecati.com" />
			...
			<a href="#" class="text-center text-rojo mb-9">Registrar nueva cuenta</a>
		</form>
	</main>
	<?php 
