...
<body>
	<header class="container text-center mx-auto md:mt-12">
	...
	<main class="container w-full flex-col mt-16 mx-auto xl:w-1/2">
		<form class="flex flex-col mx-5">
			<div class="w-full relative">
				<input class="w-full rounded-xl border-2 border-gris py-3 pl-12 my-3 placeholder-texto" 
				type="email" placeholder="Ejemplo@dcfgt.cecati.com"/>
			...
			<div class="w-full relative">
				<input class="w-full rounded-xl border-2 border-gris py-3 pl-12 pr-4 my-3 placeholder-texto" 
			...
			<a href="#" class="text-rojo text-center mt-3 md:text-right">¿Olvidaste tu contraseña?</a>
			<input type="submit" class="rounded-lg p-3 bg-rojo cursor-pointer mt-16 mb-6 text-[white]" value="INICIAR SESIÓN">
			<a href="#" class="text-center text-rojo mb-10">Registrar nueva cuenta</a>
		</form>
	</main>
</body>
