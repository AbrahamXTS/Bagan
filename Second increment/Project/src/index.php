...
<body>
	...
	<main class="container mt-16 mx-auto xl:w-1/2">
		<!-- Cambiar la ruta -->
		<form id="login" class="flex flex-col mx-5" method="POST" action="./functions/handleFormLogin.php">
			<div class="w-full relative">
				<input id="campoEmail" class="w-full rounded-xl border-2 border-gris py-3 pl-12 my-3 placeholder-texto" type="email" name="email" placeholder="Ejemplo@dcfgt.cecati.com" />
			...
			<div class="w-full relative">
				<input id="campoContrasena" class="w-full rounded-xl border-2 border-gris py-3 pl-12 pr-4 my-3 placeholder-texto" type="password" name="contrasena" placeholder="Contraseña" />
	...
	<script src="./script/handleFormLogin.js"></script> 
</body>
