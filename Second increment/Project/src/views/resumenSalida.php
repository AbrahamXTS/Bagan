...
<body class="bg-gris-claro">
	...
	<h1 class="text-center uppercase text-[27px] font-extrabold py-8">Resumen de salida</h1>
	...
	<div class="drop-shadow-xl  mx-auto rounded-md bg-blanco w-11/12 md:w-[760px] h-auto border-slate-700 mb-8 pb-3">
		<li class="list-none pl-[30px] pt-[1rem]">
			...
			<div class="flex items-center ">
				<p class="uppercase font-extrabold pr-[7px] py-[13px] text-lg">Total de salidas:</p>
				<p class="text-lg">$1,000</p>
			</div>

			<div class="flex items-center ">
				<p class="uppercase font-extrabold pr-[7px] py-[13px] text-lg">Área solicitante:</p>
				<p class="text-lg">Contaduría</p>
			</div>
		</li>

		<div class="flex justify-center pt-5 pb-5 md:justify-end md:mr-10 ">
