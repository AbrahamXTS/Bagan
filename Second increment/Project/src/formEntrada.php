...
<html>
<head>
	<title>CecatiApp | Formulario de Entrada</title>
	<meta charset="UTF-8" />
...
<body class="bg-gris-claro">
	...
	<main>
		<div class="drop-shadow-xl  mx-auto my-8 rounded-md bg-blanco w-11/12 md:w-[760px] h-auto border-slate-700 px-8 py-5">
			<form class="md:grid md:grid-cols-2 items-center md:gap-x-10">
				<div class="flex flex-col mb-[10px]">
					<label for="procedencia"class="p-2 uppercase font-bold text-lg">Procedencia</label>
					<input type="text" id="procedencia"placeholder="Digite la tienda de procedencia" class="text-texto text-lg px-5 h-[58px] w-full rounded-[10px] border-2 border-gris">
				</div>
		
				<div class="flex flex-col my-[10px] md:mt-0">
					<label for="fecha"class="p-2 uppercase font-bold text-lg">Fecha</label>
					<input type="date" id="fecha" class="text-texto text-lg px-5 h-[58px] w-full rounded-[10px] border-2 border-gris">
				</div>
				...
				<div class="flex flex-col md:col-start-1 md:col-end-3 my-[10px]">
					...
					<input type="number" id="factura"placeholder="Digite el numero de factura" class="text-texto text-lg px-5 h-[58px] w-full rounded-[10px] border-2 border-gris">
				</div>
