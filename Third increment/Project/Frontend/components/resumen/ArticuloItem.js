...
export default function ArticuloItem({tipo, fecha, clave, nombre, unidad, partida, cantidadEntrada, cantidadSalida}) {
    return (
        <div className="h-auto mx-auto my-8 rounded-md bg-[white] drop-shadow-xl w-11/12 md:w-[760px]">
            <ul className="pl-[30px] pt-[1rem]">
                ...
                <li className="flex flex-wrap items-center">
                    <p className="uppercase font-bold pr-[7px] py-[13px] text-lg">{tipo == "Entrada" ? "Cantidad de entrada: " : "Cantidad de salida: "}</p>
