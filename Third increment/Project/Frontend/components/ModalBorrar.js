        ...
        <>
            <div className="flex fixed w-[100%] h-[100vh] top-0 bg-gris bg-opacity-70 justify-center items-center z-10">
                <div className="w-[90%] sm:w-[100%] max-w-[760px] mx-[22px] px-5 py-5 bg-blanco rounded">
                    <h2 className="text-center sm:text-left text-xl sm:text-2xl font-bold h-[62.5px] sm:py-[15px] sm:px-[21px]">¿Desea deshacer los cambios?</h2>
                    <p className="text-center sm:text-left text-xl sm:text-2xl border-y border-y-gris px-[21px] py-[33.5px]">Sí borra los cambios, todos los datos ingresados se perderán.</p>
                    <div className="flex mt-4 justify-center sm:justify-end gap-4 sm:gap-7">
                        ...
                        <button type='button' className="w-40 h-16 bg-rojo rounded">
                            <p className="font-bold sm:text-2xl text-blanco">Sí, Borrar</p>
                        </button>
                    </div>
                </div>
            </div>
